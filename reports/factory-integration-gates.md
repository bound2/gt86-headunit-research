...
| Supply the wired AV network | [Step 96](factory-usb-network.md) finds native NCM and no IPv6 domain in the selected later-corpus stack | Real phone-associated interface, compatible IPv6 runtime, scoped address/listeners and lifetime ownership |
