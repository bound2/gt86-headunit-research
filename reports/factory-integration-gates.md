...
| Build a factory process | ARM portability checks are relocatable objects, not QNX executables; [Step 100](factory-native-build-route.md) establishes the ARMle-v7/SP1 corpus family and a public toolchain lead, not a usable matching SDK | Compatible, usable QNX development inputs and an actual target executable |
