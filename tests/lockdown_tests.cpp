...
static Bytes framed(const Bytes& body) {
...
static void send(Peer& peer, uint16_t port, const Bytes& data, uint32_t ack, bool fin = false) {
...
static void reply_with(Runtime& r, const Bytes& request, const Bytes& response, size_t cut = 0) {
