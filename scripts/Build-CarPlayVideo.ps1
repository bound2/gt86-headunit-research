...
try {
    ...
    cmake -S . -B build/video -G 'Visual Studio 17 2022' -A x64 "-DCARPLAY_OPENH264_SOURCE=$PWD/build/openh264-2.6.0" "-DCARPLAY_MONOCYPHER_SOURCE=$PWD/build/monocypher-4.0.3"
