...
try {
    ...
    foreach ($headunitTest in @('iap2_tests', 'iap2_link_tests', 'iap2_control_tests', 'iap2_identification_tests', 'iap2_transport_tests', 'iap2_carplay_tests', 'usbmux_tests', 'usbmux_host_tests', 'usbmux_connection_tests', 'usbmux_dispatcher_tests', 'lockdown_tests')) {
        ...
        } elseif ($headunitTest -eq 'lockdown_tests') {
