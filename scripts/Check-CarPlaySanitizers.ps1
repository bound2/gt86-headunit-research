...
$headunitObjects = @()
foreach ($headunitName in @('iap2_wire', 'iap2_auth', 'iap2_link', 'iap2_control', 'iap2_identification')) {
...
try {
    ...
    foreach ($headunitTest in @('iap2_tests', 'iap2_link_tests', 'iap2_control_tests', 'iap2_identification_tests')) {
        ...
        if ($headunitTest -in @('iap2_tests', 'iap2_identification_tests')) {
