...
$headunitObjects = @()
foreach ($headunitName in @('iap2_wire', 'iap2_auth', 'iap2_link', 'iap2_control', 'iap2_identification', 'iap2_transport', 'iap2_carplay', 'iap2_power', 'usbmux_wire', 'usbmux_host', 'usbmux_connection', 'usbmux_dispatcher', 'lockdown_wire', 'lockdown_channel', 'service_plist', 'lockdown_reply', 'lockdown_bootstrap', 'rtsp_wire', 'rtsp_channel', 'pair_tlv', 'projection_info', 'projection_timing', 'projection_events', 'projection_command')) {
...
try {
    ...
    foreach ($headunitTest in @('iap2_tests', 'iap2_link_tests', 'iap2_control_tests', 'iap2_identification_tests', 'iap2_transport_tests', 'iap2_carplay_tests', 'usbmux_tests', 'usbmux_host_tests', 'usbmux_connection_tests', 'usbmux_dispatcher_tests', 'lockdown_tests', 'service_plist_tests', 'lockdown_bootstrap_tests', 'rtsp_tests', 'pair_tlv_tests', 'projection_info_tests', 'projection_timing_tests', 'projection_events_tests')) {
        ...
        } elseif ($headunitTest -in @('lockdown_tests', 'service_plist_tests', 'lockdown_bootstrap_tests')) {
